...
let AddSpacePage = class AddSpacePage {
    ...
    onChange(name, isChecked) {
        const cartoons = this.addCoSpaceForm.controls.name;
        if (isChecked) {
    ...
    submit() {
        ...
        this.ownerservice.addcoworkingSpace(this.account.getUserSession(), this.profileUid, this.addCoSpaceForm.value.categories, this.addCoSpaceForm.value.category_number, this.addCoSpaceForm.value.address, this.addCoSpaceForm.value.city, this.addCoSpaceForm.value.province, this.addCoSpaceForm.value.name, this.cardImageBase64, this.addCoSpaceForm.value.price, this.addCoSpaceForm.value.description);
        // this.reload();
        //  this.  CreatePopover()
    }
    // async reload() {
