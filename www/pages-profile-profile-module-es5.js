(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-profile-profile-module"], {
    ...
    function srcAppPagesProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @ionic/angular */
      "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js"); // import { join } from 'path';
      // import { data } from 'jquery';


      var ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(ownerservice, account, loadingCtrl) {
        ...
        _createClass(ProfilePage, [{
          ...
          value: function ionViewDidEnter() {
            ...
            firebase_app__WEBPACK_IMPORTED_MODULE_3__["default"].firestore().collectionGroup("profile").where("uid", "==", this.account.getUserSession()).onSnapshot(function (querySnapshot) {
              querySnapshot.forEach(function (doc) {
                _this.profile = doc.data(); // this.array.push(doc.data());

                _this.profileUid = doc.id;
                console.log("data: ", _this.profile); // this.ionViewDidEnter();
                // window.location.reload();
                // window.stop();
              }); // cities.push(doc.data());

              console.log("Current profile: ", _this.profile);
            });
